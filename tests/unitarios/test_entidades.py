...
class MPTransparenteMontandoMalote(unittest.TestCase):
    ...
    def test_deve_montar_conteudo_com_parcelas_com_juros(self):
        malote = entidades.Malote(mock.MagicMock(loja_id=8, informacao_complementar='NOMELOJA'))
