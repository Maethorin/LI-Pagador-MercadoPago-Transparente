...
MENSAGENS_RETORNO = {
    ...
    '159': u'Seu pagamento não pode ser processado. Verifique seu cadastro junto ao MercadoPago através desse <a href="https://www.mercadopago.com.br/ajuda/contactForm?form_id=148">formulário</a> informando a situação e o código de erro: 159.',
    ...
    'payer_unavailable': u'Seu pagamento não pode ser processado. Verifique seu cadastro junto ao MercadoPago através desse <a href="https://www.mercadopago.com.br/ajuda/contactForm?form_id=148">formulário</a> informando a situação e o código de erro: payer_unavailable.',
